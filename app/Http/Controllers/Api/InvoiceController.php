...
class InvoiceController extends Controller
{
     ...
     *         )
     *     ),
     *     @OA\Response(response=201, description="Invoice created successfully", @OA\JsonContent(ref="#/components/schemas/Invoice"))
     * )
     */
     ...
     *     security={{"sanctum":{}}},
     *     @OA\Parameter(name="invoice", in="path", required=true, @OA\Schema(type="integer"), description="Invoice ID"),
     *     @OA\Response(response=200, description="Invoice details", @OA\JsonContent(ref="#/components/schemas/Invoice")),
     ...
     *         )
     *     ),
     *     @OA\Response(response=200, description="Invoice updated successfully", @OA\JsonContent(ref="#/components/schemas/Invoice"))
     * )
     */
